 ...
 *
 */
public class CoinAssetsQuotationRateHistory24hJob implements BaseJob {
    private static final Logger logger = LoggerFactory.getLogger(CoinAssetsQuotationRateHistory24hJob.class);
